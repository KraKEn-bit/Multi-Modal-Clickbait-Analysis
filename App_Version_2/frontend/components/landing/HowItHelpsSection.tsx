...
export function ResultsPreview({ example }: { example: AnalysisResult }) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-[0_2px_8px_rgba(28,27,24,0.05),0_28px_64px_-24px_rgba(28,27,24,0.18)]">
      ...
      <div className={`border-b border-border px-5 py-4 ${verdictBg}`}>
        ...
        <p className={`mt-1 text-2xl font-bold ${verdictColor}`}>{example.verdict}</p>
    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        <ScrollRevealItem>
          ...
          <h2 className="mt-3 max-w-2xl font-serif text-3xl font-normal leading-snug tracking-tight text-foreground sm:text-4xl">
